...
class AdvancedGraphRAGSystem:
    """Stable application surface for CLI today and service endpoints later."""
    ...
    def __init__(
        ...
        *,
        ...
        self.interactive_service: SystemInteractiveProtocol = container.interactive_service
