...
def demo_normalization():
    ...
    for amount, unit in test_cases:
        normalized, estimated = normalizer.normalize_amount(amount, unit)
        formatted = normalizer.format_amount(amount, unit)
        print(
            f"{amount!r} {unit!r} -> normalized={normalized!r} "
            f"estimated={estimated!r} formatted={formatted!r}"
        )
